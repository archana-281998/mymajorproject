...
namespace EFashion.Web.Areas.Users.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderId,OrderDate,Discount,Quantity,Price,CustomerId,ItemId")] Order order)
        {
        ...
        // POST: Users/Orders/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,OrderDate,Discount,Quantity,Price,CustomerId,ItemId")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
